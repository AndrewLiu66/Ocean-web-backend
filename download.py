...
# generate method
def generateSpectrogramCsvValue(slice_data):
...
def generateCsvSPDF(spec_slice):
    ...
    L95 = spdf['95']
    L99 = spdf['99']
    spdf_df = pd.DataFrame(zip(freq, L1, L5, L10, L50, L90, L95, L99), columns=['Frequency','Level 1', 'Level 5', 'Level 10', 'Level 50', 'Level 90', 'Level 95', 'Level 99'])
